...
public class IcsLinearLayout extends LinearLayout {
	...
	public IcsLinearLayout(Context context, AttributeSet attrs) {
		...
		TypedArray a = context.obtainStyledAttributes(attrs,
				R.styleable.IcsDividerStyle);
		try {
			setDividerDrawable(a
					.getDrawable(R.styleable.IcsDividerStyle_divider_drawable));
			mDividerPadding = a.getDimensionPixelSize(
					R.styleable.IcsDividerStyle_divider_padding, 0);
			mShowDividers = a.getInteger(
					R.styleable.IcsDividerStyle_divider_location,
					SHOW_DIVIDER_NONE);
		} finally {
			a.recycle();
		}
