...
public abstract class FragmentTabGroup extends BaseTabGroup {
	...
	public void setupInFragment(Fragment fragment, int tabBarLocation) {
		setupInFragment(fragment, tabBarLocation, true);
	}

	public void setupInFragment(Fragment fragment, int tabBarLocation,
			boolean autoScroll) {
		mFragmentManager = fragment.getChildFragmentManager();
		super.setup(tabBarLocation, autoScroll);
	}
	...
	public Fragment getCurrentFragment() {
		...
		if (tabInfo != null) {
			fragment = findFragmentByTag(tabInfo.tag);
		}
		return fragment;
	}
	...
	public List<Fragment> getAllFragments() {
		...
		for (TabInfo tabInfo : mTabs) {
			Fragment fragment = findFragmentByTag(tabInfo.tag);
			if (fragment != null) {
