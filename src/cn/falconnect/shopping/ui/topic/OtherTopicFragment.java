...
public class OtherTopicFragment extends SlidingExitFragment {
	...
	protected View onChildCreateView(LayoutInflater inflater,
		...
		View contentView = inflater.inflate(R.layout.othertopicfragment, null);
	...
	private void initViews(View view) {
		CircleImageView avatarImageView = (CircleImageView) view
				.findViewById(R.id.other_iv_avatar);
		TextView nickNameTextView = (TextView) view
				.findViewById(R.id.other_tv_nick_name);
		TextView postContentTextView = (TextView) view
				.findViewById(R.id.other_tv_post_content);
		ImageHelper
