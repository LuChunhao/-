...
public class OtherTopicDetailFragment extends SlidingExitFragment {
	public static final String FRAGMENT_TAG = "OtherTopicDetailFragment";
	...
	protected View onChildCreateView(LayoutInflater inflater,
		...
		View contentView = inflater.inflate(
				R.layout.other_fragment_topic_detail, null);
	...
	private void initViews(View view) {
		CircleImageView avatarImageView = (CircleImageView) view
				.findViewById(R.id.other2_iv_avatar);
		TextView nickNameTextView = (TextView) view
				.findViewById(R.id.other2_tv_nick_name);
		TextView postContentTextView = (TextView) view
				.findViewById(R.id.other2_tv_post_content);
		ImageHelper
		...
		PlaWaterfallListView picWaterFall = (PlaWaterfallListView) view
				.findViewById(R.id.other2_show_list);
	...
	private void initDrawerLayout() {
		...
		getFragmentManager()
				.beginTransaction()
				.replace(R.id.other_comments_layout, drawerFragment,
